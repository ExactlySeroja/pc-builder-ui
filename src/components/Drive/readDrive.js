...
export default function ReadDrive({ apiData, setApiData, showUpdateModal, setShowUpdateModal, showCreateModal, setShowCreateModal }) {

    const handleDelete = (id) => {
        if (window.confirm('Are you sure you want to delete this item?')) {
                driveService.deleteDrive(id).then(() => {
    ...
    const handleUpdateClick = (id) => {
        setShowUpdateModal({ show: true, selectedDriveId: id })
    }
