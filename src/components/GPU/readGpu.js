...
export default function ReadGpu({ apiData, setApiData, showUpdateModal, setShowUpdateModal, showCreateModal, setShowCreateModal }) {

    const handleDelete = (id) => {
        if (window.confirm('Are you sure you want to delete this item?')) {
                gpuService.deleteGpu(id).then(() => {
    ...
    const handleUpdateClick = (id) => {
        setShowUpdateModal({ show: true, selectedGpuId: id })
    }
