...
const UpdatePowerUnitModal = ({ powerUnitId, show, setShow, apiData, setApiData }) => {
    const [name, setName] = useState('');
    const [price, setPrice] = useState('');
    const handleClose = () => setShow(false);
    const handleShow = () => setShow(true);
    const handleSubmit = () => {
        powerUnitService.updatePowerUnit(powerUnitId, name, price).then(() => {
...
export default UpdatePowerUnitModal