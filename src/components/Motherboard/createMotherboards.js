...
const CreateMotherboardsModal = ({ show, setShow, apiData, setApiData }) => {
  ...
  const handleSubmit = () => {
    ...
    motherboardService.createMotherboard(name, price, socket, ramSlot).then((data) => {
      if (data) {
...
export default CreateMotherboardsModal