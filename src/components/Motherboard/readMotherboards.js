...
export default function ReadMotherboards({ apiData, setApiData, showUpdateModal, setShowUpdateModal, showCreateModal, setShowCreateModal }) {

    const handleDelete = (id) => {
        if (window.confirm('Are you sure you want to delete this item?')) {
                motherboardService.deleteMotherboard(id).then(() => {
    ...
    const handleUpdateClick = (id) => {
        setShowUpdateModal({ show: true, selectedMotherBoardId: id })
    }
