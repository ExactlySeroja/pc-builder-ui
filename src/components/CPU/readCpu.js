...
export default function ReadCpu({ apiData, setApiData, showUpdateModal, setShowUpdateModal, showCreateModal, setShowCreateModal }) {

    const handleDelete = (id) => {
        if (window.confirm('Are you sure you want to delete this item?')) {
                cpuService.deleteCpu(id).then(() => {
    ...
    const handleUpdateClick = (id) => {
        setShowUpdateModal({ show: true, selectedCpuId: id })
    }
